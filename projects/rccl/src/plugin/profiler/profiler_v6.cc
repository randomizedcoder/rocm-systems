  ...
  case ncclProfileProxyOp:
    {
      ...
      /* RCCL: proxy-diag / proxy-trace extension fields */
      eDescr_v6.proxyOp.commHash = eDescr->proxyOp.commHash;
      eDescr_v6.proxyOp.opCount = eDescr->proxyOp.opCount;
      eDescr_v6.proxyOp.traceFuncIdx = eDescr->proxyOp.traceFuncIdx;
      eDescr_v6.proxyOp.traceProtocol = eDescr->proxyOp.traceProtocol;
      eDescr_v6.proxyOp.tracePattern = eDescr->proxyOp.tracePattern;
      eDescr_v6.proxyOp.traceTotalBytes = eDescr->proxyOp.traceTotalBytes;
      eDescr_v6.proxyOp.proxyNbytes = eDescr->proxyOp.proxyNbytes;
      eDescr_v6.proxyOp.rawProxyNsteps = eDescr->proxyOp.rawProxyNsteps;
    }
    break;
...
static ncclResult_t ncclProfiler_recordEventState(void* eHandle, ncclProfilerEventState_t eState,
  ...
  if (eStateArgs) {
    ...
    case ncclProfilerKernelChStop:
      ...
      break;
    /* RCCL: proxy-diag counters are part of the v6 interface */
    case ncclProfilerProxyDiagUpdate:
      eStateArgs_v6.proxyDiag.counterKind = eStateArgs->proxyDiag.counterKind;
      eStateArgs_v6.proxyDiag.flags = eStateArgs->proxyDiag.flags;
      eStateArgs_v6.proxyDiag.value = eStateArgs->proxyDiag.value;
      eStateArgs_v6.proxyDiag.value2 = eStateArgs->proxyDiag.value2;
      break;
    default:
      break;
    }
